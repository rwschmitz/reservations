...
var ViewReservations_1 = __importStar(require("../ViewReservations"));
var fakeReservation = {
    id: '2903482askdjf',
    name: 'Jim Raynor',
...
describe('<ViewReservations />', function () {
    it('Displays the loading state correctly', function () {
        var mocks = [
            {
                request: {
                    query: ViewReservations_1.ALL_RESERVATIONS_QUERY
                },
                result: {
                    data: {
        ...
        var wrapper = enzyme_1.mount(react_1.default.createElement(test_utils_1.MockedProvider, { mocks: mocks, addTypename: false },
            react_1.default.createElement(ViewReservations_1.default, { navigation: {
                    navigate: function () { }
                } })));
        expect(wrapper.text()).toContain('Loading, please wait a moment!');
    });
    it('Pulls in reservations data', function () { return __awaiter(_this, void 0, void 0, function () {
        var mocks, wrapper;
    ...
    it('Errors out correctly', function () { return __awaiter(_this, void 0, void 0, function () {
        var mocks, wrapper;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
